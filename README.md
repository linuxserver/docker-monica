...
| `-e APP_URL=http://localhost:80` | The URL you will use to access Monica including protocol, and port where appropriate. |
...
| `-e APP_ENV=local` | Set to `production` when exposing the container to anyone else; this also makes https mandatory. |
| `-e APP_DISABLE_SIGNUP=true` | Set to `false` to enable new account sign-ups. |
