pipeline {
  ...
  environment {
    ...
    EXT_USER = 'monicahq'
    EXT_REPO = 'monica'
    BUILD_VERSION_ARG = 'MONICA_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-monica'
    CONTAINER_NAME = 'monica'
    DOCKERHUB_IMAGE = 'linuxserver/monica'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/monica'
    PR_DOCKERHUB_IMAGE = 'lspipepr/monica'
    DIST_IMAGE = 'alpine'
    MULTIARCH='true'
    CI='false'
    CI_WEB='false'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.title=Monica\" \
          --label \"org.opencontainers.image.description=[Monica](https://github.com/monicahq/monica) is an open source personal relationship management system, that lets you document your life.  \" \
